...
mex -DranSHR3 -f mexopts_intel10.bat -output particle_resampling.dll particle_resampling.c
...
void randini(void);  
void particle_resampling(double * , double * , int );
...
/* -------------------------------------------------------------------------------------------- */
void particle_resampling(double *pdf , double *indice , int N)	 
{
	int    i  , j;
