...
void part_moment(double * , double * , double * , double * , int , int  , int  );
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs,  const mxArray *prhs[])
{
	...
	part_moment(S , w , Smean ,  Pcov , d , N , slice );
...
/*-------------------------------------------------------------------------------------------------*/
void part_moment(double *S , double *w , double *Smean , double *Pcov , int d , int N , int slice )
{
	int i , j , t ,  v;
	...
	Stemp  =  (double *)malloc(slice*d*N*sizeof(double));
