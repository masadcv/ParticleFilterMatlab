/*
  ...
  pdf is computed by monte-carlo approximation by drawing samples uniformely inside the ellipse
  ...
  ------
   ...
   Npdf            Number of samples to copute the color histogram (default Npdf = 100)
...
{	
	...
	{
		vect_edge2 = (double *)malloc(1*9*sizeof(double));
        Ny         = 8;
		cte2       = 1/Ny;
		for (i = 0; i < Ny + 1 ; i++)
		{		
